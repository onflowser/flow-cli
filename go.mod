...
// TODO: Else flow-go should be updated (forked) to the latest preview version
...
replace github.com/onflow/go-ethereum => ../go-ethereum

replace github.com/gofrs/flock => ../flock
